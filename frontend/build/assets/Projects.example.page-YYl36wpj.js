import{j as a}from"./vendor-D_nTE7E-.js";import{H as r,r as s,z as i,p as e,s as d,x as t,y as o,E as n,C as c,aX as l,aY as m,aC as p}from"./chunk-icon-Pdyc-Xig.js";import"./chunk-mdviewer-RzNt5nmr.js";import"./chunk-highlighter-bh0nNJlE.js";const v=`// @start-snippet:: projectCardExampleSource
import Card, {
	CardBody,
	CardFooter,
	CardFooterChild,
...
`,u=()=>a.jsxs(a.Fragment,{children:[a.jsxs(r,{children:[a.jsx(s,{children:a.jsx(i,{list:[{...e.examples.exampleMain},{...e.examples.exampleMain.subPages.cards},{...e.examples.exampleMain.subPages.cards.subPages.projects}]})}),a.jsxs(d,{children:[a.jsx(t,{}),a.jsx(o,{}),a.jsx(n.Ui.Dropdown.Notifications,{})]})]}),a.jsx(c,{children:a.jsxs("div",{className:"grid grid-cols-12 gap-4",children:[a.jsx(l,{title:"Projects",description:"Cards containing files, statuses and all kinds of information for projects."}),a.jsx(m,{title:"Project Card",iFrameProps:{initialWidth:420},code:p(v,"projectCardExampleSource"),children:a.jsx("div",{className:"flex flex-col gap-4",children:a.jsx(n.Card.Project.Card,{})})})]})})]});export{u as default};
