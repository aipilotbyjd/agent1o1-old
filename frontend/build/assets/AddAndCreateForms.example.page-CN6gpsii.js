import{j as n}from"./vendor-D_nTE7E-.js";import{H as l,r as o,z as s,p as e,s as i,x as r,y as t,E as a,C as d,aX as m,aY as c,aC as p}from"./chunk-icon-Pdyc-Xig.js";import"./chunk-mdviewer-RzNt5nmr.js";import"./chunk-highlighter-bh0nNJlE.js";const u=`// @start-snippet:: addCreateNewUserExampleSource
...
`,x=()=>n.jsxs(n.Fragment,{children:[n.jsxs(l,{children:[n.jsx(o,{children:n.jsx(s,{list:[{...e.examples.exampleMain},{...e.examples.exampleMain.subPages.forms},{...e.examples.exampleMain.subPages.forms.subPages.addAndCreateForms}]})}),n.jsxs(i,{children:[n.jsx(r,{}),n.jsx(t,{}),n.jsx(a.Ui.Dropdown.Notifications,{})]})]}),n.jsx(d,{children:n.jsxs("div",{className:"grid grid-cols-12 gap-4",children:[n.jsx(m,{title:"Add/Create Forms",description:"Visually captivating experiences with admin forms, WYSIWYG editor, date picker, create content and more."}),n.jsx(c,{title:"New User",code:p(u,"addCreateNewUserExampleSource"),iFrameProps:{initialWidth:640},children:n.jsx(a.Forms.AddCreate.NewUser,{})})]})})]});export{x as default};
