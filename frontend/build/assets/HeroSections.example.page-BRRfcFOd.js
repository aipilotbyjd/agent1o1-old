import{j as n}from"./vendor-D_nTE7E-.js";import{H as l,r as a,z as s,p as e,s as o,x as C,y as d,E as t,C as c,aX as h,aY as i,aC as r}from"./chunk-icon-Pdyc-Xig.js";import"./chunk-mdviewer-RzNt5nmr.js";import"./chunk-highlighter-bh0nNJlE.js";const x=`// @start-snippet:: heroSectionWithImageAndTextExampleSource
				...
				<div className='grid gap-4 md:grid-cols-2 md:items-center md:gap-8 xl:gap-20'>
					<div>
						<h1 className='block text-3xl font-bold text-zinc-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white'>
							...
							<span className='text-blue-600'>Boltify</span>
						</h1>
						<p className='mt-3 text-lg text-zinc-800 dark:text-zinc-400'>
						...
						<div className='mt-7 grid w-full gap-3 sm:inline-flex'>
							...
							<a
								className='inline-flex items-center justify-center gap-x-2 rounded-lg border border-zinc-200 bg-white px-4 py-3 text-sm font-medium text-zinc-800 shadow-2xs hover:bg-zinc-50 focus:bg-zinc-50 focus:outline-hidden disabled:pointer-events-none disabled:opacity-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white dark:hover:bg-zinc-800 dark:focus:bg-zinc-800'
								href='/'>
								Contact sales team
							</a>
						</div>
						...
						<div className='mt-6 grid grid-cols-2 gap-x-5 lg:mt-10'>
							...
							<div className='py-5'>
								...
								<p className='mt-3 text-sm text-zinc-800 dark:text-zinc-200'>
									<span className='font-bold'>4.9</span> /5 - from 12k reviews
								</p>
							...
							<div className='py-5'>
								...
								<p className='mt-3 text-sm text-zinc-800 dark:text-zinc-200'>
									<span className='font-bold'>4.4</span> /5 - from 5k reviews
								</p>
					...
					<div className='relative ms-4'>
						<img
							...
							src='https://images.unsplash.com/photo-1604328727766-a151d1045ab4?q=80&auto=format&fit=crop&w=700&h=800&q=80'
							alt='Team collaboration on a laptop'
						/>
						<div className='absolute inset-0 -z-1 -ms-4 me-4 mt-4 -mb-4 size-full rounded-md bg-linear-to-tr from-zinc-200 via-white/0 to-white/0 lg:-ms-6 lg:me-6 lg:mt-6 lg:-mb-6 dark:from-zinc-800 dark:via-zinc-900/0 dark:to-zinc-900/0'></div>

						{/* SVG*/}
						<div className='absolute start-0 bottom-0'>
							<svg
								className='ms-auto h-auto w-2/3 text-white dark:text-zinc-900'
								width='630'
								height='451'
								viewBox='0 0 630 451'
								fill='none'
...
// @end-snippet:: heroSectionWithImageAndTextExampleSource
`,m=`// @start-snippet:: heroSectionsTextAndButtonExampleSource
...
`,f=()=>n.jsxs(n.Fragment,{children:[n.jsxs(l,{children:[n.jsx(a,{children:n.jsx(s,{list:[{...e.examples.exampleMain},{...e.examples.exampleMain.subPages.pageSections},{...e.examples.exampleMain.subPages.pageSections.subPages.heroSections}]})}),n.jsxs(o,{children:[n.jsx(C,{}),n.jsx(d,{}),n.jsx(t.Ui.Dropdown.Notifications,{})]})]}),n.jsx(c,{children:n.jsxs("div",{className:"grid grid-cols-12 gap-4",children:[n.jsx(h,{title:"Hero Sections",description:"Hero sections instantly captivate visitors with bold visuals and compelling messages, making a powerful first impression and setting the tone for your entire site."}),n.jsx(i,{title:"With Image and Text",code:r(x,"heroSectionWithImageAndTextExampleSource"),children:n.jsx("div",{className:"flex flex-col gap-4",children:n.jsx(t.PageSections.HeroSections.WithImageAndText,{})})}),n.jsx(i,{title:"Text and Button",code:r(m,"heroSectionsTextAndButtonExampleSource"),children:n.jsx("div",{className:"flex flex-col gap-4",children:n.jsx(t.PageSections.HeroSections.TextAndButton,{})})})]})})]});export{f as default};
