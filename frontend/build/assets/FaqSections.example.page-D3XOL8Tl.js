import{j as e}from"./vendor-D_nTE7E-.js";import{H as a,r as i,z as o,p as n,s,x as r,y as d,E as t,C as l,aX as c,aY as p,aC as m}from"./chunk-icon-Pdyc-Xig.js";import"./chunk-mdviewer-RzNt5nmr.js";import"./chunk-highlighter-bh0nNJlE.js";const u=`// @start-snippet:: faqSectionsRightAlignedWithBorderBottomExampleSource
...
`,f=()=>e.jsxs(e.Fragment,{children:[e.jsxs(a,{children:[e.jsx(i,{children:e.jsx(o,{list:[{...n.examples.exampleMain},{...n.examples.exampleMain.subPages.pageSections},{...n.examples.exampleMain.subPages.pageSections.subPages.faqSections}]})}),e.jsxs(s,{children:[e.jsx(r,{}),e.jsx(d,{}),e.jsx(t.Ui.Dropdown.Notifications,{})]})]}),e.jsx(l,{children:e.jsxs("div",{className:"grid grid-cols-12 gap-4",children:[e.jsx(c,{title:"FAQ Sections",description:"The FAQ section delivers clear answers to frequently asked questions, making it easy for users to quickly find the information and support they need."}),e.jsx(p,{title:"Right Aligned with Border Bottom",code:m(u,"faqSectionsRightAlignedWithBorderBottomExampleSource"),children:e.jsx("div",{className:"flex flex-col gap-4",children:e.jsx(t.PageSections.FaqSections.RightAlignedWithBorderBottom,{})})})]})})]});export{f as default};
