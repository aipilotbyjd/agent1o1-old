...
const SettingsRow = ({
	...
	<div className='grid gap-4 border-b border-zinc-200 py-6 lg:grid-cols-[minmax(240px,1fr)_minmax(420px,1.05fr)] lg:items-center'>
		<div>
			...
			{description && <div className='mt-1 text-sm font-medium text-zinc-500'>{description}</div>}
		</div>
		...
		<div className='flex min-w-0 flex-1 overflow-hidden bg-[#fbfbfc] text-zinc-950'>
			<aside className='hidden w-[286px] shrink-0 flex-col border-r border-zinc-200 bg-white md:flex'>
				<div className='flex h-20 items-center justify-between px-5'>
					<div className='text-3xl font-black tracking-[-0.04em] text-zinc-950'>Agent1o1</div>
					<button
						type='button'
				...
				<div className='min-h-0 flex-1 overflow-y-auto px-3 pb-4'>
					...
					<div className='space-y-7'>
						...
						<section>
							<div className='mb-2 px-2 text-xs font-bold text-zinc-500'>Organization</div>
							<div className='space-y-1'>
						...
						<section>
							<div className='mb-2 px-2 text-xs font-bold text-zinc-500'>AI Providers</div>
							<div className='space-y-1'>
			...
			<main className='min-w-0 flex-1 overflow-y-auto'>
				<div className='mx-auto w-full max-w-[1180px] px-6 py-10 sm:px-10 lg:px-14 lg:py-16'>
					...
					<section>
						...
						<div className='grid gap-4 border-b border-zinc-200 py-6 lg:grid-cols-[minmax(240px,1fr)_minmax(420px,1.05fr)] lg:items-center'>
							<div className='flex min-w-0 items-center gap-5'>
								<img src={avatar} alt='Profile' className='h-21 w-21 rounded-xl object-cover' />
								<div>
						...
						<SettingsRow
							...
							<div className='grid w-full gap-3 sm:grid-cols-2'>
								<input className={inputClass} defaultValue='Amaan' aria-label='First name' />
						...
						<SettingsRow title='Timezone' description='Your local timezone for time-based features'>
					...
					<section className='mt-9 border-t border-zinc-100 pt-9'>
						<h2 className='text-xl font-bold tracking-tight text-zinc-950'>Danger zone</h2>
