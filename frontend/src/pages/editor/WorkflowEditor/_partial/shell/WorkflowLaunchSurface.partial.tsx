						...
						<div className='border-b border-zinc-100 p-4 sm:p-5'>
							<label className='flex h-12 items-center gap-3 rounded-2xl border border-zinc-300 bg-white px-4 shadow-xs focus-within:border-emerald-300 focus-within:ring-4 focus-within:ring-emerald-100'>
								...
								<input
									...
									className='min-w-0 flex-1 appearance-none border-0 bg-transparent text-base font-medium text-zinc-800 shadow-none outline-none placeholder:text-zinc-400 focus:border-0 focus:outline-none focus:ring-0 focus:shadow-none focus-visible:outline-none focus-visible:ring-0'
									autoFocus
								/>
							</label>
						</div>
