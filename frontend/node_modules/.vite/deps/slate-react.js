import {
  ...
  Text,
  Transforms
} from "./chunk-J63LOCWJ.js";
import {
  require_lib
} from "./chunk-U3CRCP74.js";
import {
  require_react_dom
...
var PLACEHOLDER_SYMBOL = /* @__PURE__ */ Symbol("placeholder");
var MARK_PLACEHOLDER_SYMBOL = /* @__PURE__ */ Symbol("mark-placeholder");
var DOMEditor = {
...
function normalizePoint(editor, point) {
  ...
  var parentBlock = Editor.above(editor, {
    match: (n3) => Node.isElement(n3) && Editor.isBlock(editor, n3),
    at: path
  });
  if (!parentBlock) {
    return null;
...
var withDOM = function withDOM2(editor) {
  ...
  e3.deleteBackward = (unit) => {
    ...
    if (e3.selection && Range.isCollapsed(e3.selection)) {
      var parentBlockEntry = Editor.above(e3, {
        match: (n3) => Node.isElement(n3) && Editor.isBlock(e3, n3),
        at: e3.selection
      });
      if (parentBlockEntry) {
  ...
  e3.apply = (op) => {
    ...
    if (pendingAction !== null && pendingAction !== void 0 && pendingAction.at) {
      var at = Location.isPoint(pendingAction === null || pendingAction === void 0 ? void 0 : pendingAction.at) ? transformPendingPoint(e3, pendingAction.at, op) : transformPendingRange(e3, pendingAction.at, op);
...
var useAndroidInputManager = !IS_ANDROID ? () => null : (_ref) => {
  ...
  var [inputManager] = (0, import_react.useState)(() => createAndroidInputManager(_objectSpread$7({
    editor
  }, options)));
...
var ZeroWidthString = (props) => {
  ...
  return import_react.default.createElement("span", _objectSpread$6({}, attributes), !IS_ANDROID || !isLineBreak ? "\uFEFF" : null, isLineBreak ? import_react.default.createElement("br", null) : null);
};
...
var defaultRenderLeaf = (props) => import_react.default.createElement(DefaultLeaf, _objectSpread$5({}, props));
var Leaf = (props) => {
  var {
    leaf,
    isLast,
...
var DefaultLeaf = (props) => {
  ...
  return import_react.default.createElement("span", _objectSpread$5({}, attributes), children);
};
...
var defaultRenderText = (props) => import_react.default.createElement(DefaultText, _objectSpread$4({}, props));
var Text2 = (props) => {
  var {
...
var defaultRenderElement = (props) => import_react.default.createElement(DefaultElement, _objectSpread$3({}, props));
var Element2 = (props) => {
  var {
    decorations: parentDecorations,
    element,
...
var DefaultElement = (props) => {
  ...
  return import_react.default.createElement(Tag, _objectSpread$3(_objectSpread$3({}, attributes), {}, {
    style: {
      position: "relative"
    }
  }), children);
...
var ChunkTree = (props) => {
  ...
  return import_react.default.createElement(ChunkAncestor, _objectSpread$12({}, props));
};
...
var useChildren = (props) => {
  ...
  if (!chunking) {
    return node.children.map((n3, i) => Node.isText(n3) ? renderTextComponent(n3, i) : renderElementComponent(n3, i));
  }
