...
function useChildren(list, startIndex, endIndex, scrollWidth, offsetX, setNodeRef, renderFunc, _ref) {
  ...
  return list.slice(startIndex, endIndex + 1).map(function(item, index2) {
    ...
    return React15.createElement(Item, {
      key,
...
var ScrollBar = React21.forwardRef(function(props, ref) {
...
function RawList(props, ref) {
  ...
  return React22.createElement("div", _extends({
  ...
  }, containerProps, restProps), React22.createElement(es_default, {
    onResize: onHolderResize
  }, React22.createElement(Component5, {
    className: "".concat(prefixCls, "-holder"),
    style: componentStyle,
    ref: componentRef,
    onScroll: onFallbackScroll,
    onMouseEnter: delayHideScrollBar
  }, React22.createElement(Filler_default, {
    prefixCls,
    height: scrollHeight,
    offsetX: offsetLeft,
    offsetY: fillerOffset,
    ...
    rtl: isRTL,
    extra: extraContent
  }, listChildren))), inVirtual && scrollHeight > height && React22.createElement(ScrollBar_default, {
    ...
    showScrollBar
  }), inVirtual && scrollWidth > size.width && React22.createElement(ScrollBar_default, {
...
var List = React22.forwardRef(RawList);
...
var Indent = function Indent2(_ref) {
  ...
  for (var i = 0; i < level; i += 1) {
    list.push(React32.createElement("span", {
      key: i,
...
var Indent_default = React32.memo(Indent);
...
var TreeNode = function TreeNode2(props) {
  ...
  var renderSwitcher = function renderSwitcher2() {
    if (memoizedIsLeaf) {
      ...
      return _switcherIconDom !== false ? import_react14.default.createElement("span", {
    ...
    return switcherIconDom !== false ? import_react14.default.createElement("span", {
      onClick: onExpand,
  ...
  var selectorNode = import_react14.default.useMemo(function() {
    ...
    if (context.showIcon) {
      ...
      $icon = currentIcon ? import_react14.default.createElement("span", {
    ...
    }, $icon, import_react14.default.createElement("span", {
  ...
  return import_react14.default.createElement("div", _extends({
    ...
    onMouseMove
  }, ariaSelected, dataOrAriaAttributeProps), import_react14.default.createElement(Indent_default, {
    prefixCls: context.prefixCls,
    level,
    isStart,
    isEnd
...
var MotionTreeNode = React35.forwardRef(function(oriProps, ref) {
  ...
  if (motionNodes) {
    return React35.createElement(es_default3, _extends({
      ref,
      visible
    }, motion, {
      ...
      return React35.createElement("div", {
        ...
        return React35.createElement(TreeNode_default, _extends({}, restProps, treeNodeProps, {
          title,
          active,
          data: treeNode.data,
          key,
  ...
  return React35.createElement(TreeNode_default, _extends({
    domRef: ref,
    className,
    style: style2
  }, props, {
...
var NodeList = React36.forwardRef(function(props, ref) {
  ...
  return React36.createElement(React36.Fragment, null, focused && activeItem && React36.createElement("span", {
    style: HIDDEN_STYLE,
    "aria-live": "assertive"
  }, getAccessibilityPath(activeItem)), React36.createElement("div", null, React36.createElement("input", {
    style: HIDDEN_STYLE,
  ...
  }))), React36.createElement(es_default2, _extends({}, domProps, {
    data: mergedData,
    itemKey,
    height,
    fullHeight: false,
    ...
    return React36.createElement(MotionTreeNode_default, _extends({}, restProps, treeNodeProps, {
      title,
...
var Tree = (function(_React$Component) {
  ...
  function Tree2() {
    ...
    _defineProperty(_assertThisInitialized(_this), "listRef", React38.createRef());
  ...
  _createClass(Tree2, [{
    ...
    value: function render() {
      ...
      return React38.createElement(TreeContext.Provider, {
        value: contextValue
        ...
        style: rootStyle
      }, React38.createElement(NodeList_default, _extends({
        ref: this.listRef,
        prefixCls,
        style: style2,
        data: flattenNodes,
